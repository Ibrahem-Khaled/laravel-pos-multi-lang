    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="main_price">{{ __('product.main_price') }}</label>
                    <input type="text" name="main_price" class="form-control @error('main_price') is-invalid @enderror"
                        id="main_price" placeholder="{{ __('product.main_price') }}"
                        value="{{ old('main_price', $product->main_price) }}">
                    @error('main_price')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
